...
fn main() {
    ...
    writeln!(
        &mut f,
        "pub mod main_router {{domichain_program::declare_id!(\"{}\"); }}",
        main_router_id
    )
    .expect(&write_error);
    ...
    writeln!(
        &mut f,
        "pub mod main_router_admin {{domichain_program::declare_id!(\"{}\"); }}",
        main_router_admin
    )
    .expect(&write_error);
    ...
    writeln!(
        &mut f,
        "pub mod main_router_multisig {{domichain_program::declare_id!(\"{}\"); }}",
    ...
    writeln!(
        &mut f,
        "pub mod zero {{domichain_program::declare_id!(\"{}\"); }}",
        zero_id
    )
    .expect(&write_error);
