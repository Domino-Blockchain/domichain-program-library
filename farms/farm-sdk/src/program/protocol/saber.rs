...
pub mod saber_redeemer {
    domichain_program::declare_id!("RDM23yr8pr1kEAmhnFpaabPny6C9UVcEcok3Py5v86X");
}

pub mod saber_decimal_wrapper {
    domichain_program::declare_id!("DecZY86MU5Gj7kppfUCEmd4LbXXuyZH1yHaP2NTqdiZB");
}

pub mod saber_to_usdc_amm {
    domichain_program::declare_id!("5cmAS6Mj4pG2Vp9hhyu3kpK9yvC7P6ejh9HiobpTE6Jc");
}
