...
```console
$ spl-token --program-id BvVePGKKwuGb6QVJHG6LvCrULB7QBgjocqnYxYHUkNEd create-token --enable-close
Creating token C47NXhUTVEisCfX7s16KrxYyimnui7HpUXZecE2TmLdB under program BvVePGKKwuGb6QVJHG6LvCrULB7QBgjocqnYxYHUkNEd
```
...
possible to close the mint account and reclaim the satomis on the mint account.
...
```console
$ spl-token --program-id BvVePGKKwuGb6QVJHG6LvCrULB7QBgjocqnYxYHUkNEd create-token --transfer-fee 50 5000
Creating token Dg3i18BN7vzsbAZDnDv3H8nQQjSaPUTqhwX41J7NZb5H under program BvVePGKKwuGb6QVJHG6LvCrULB7QBgjocqnYxYHUkNEd
...
```console
$ spl-token --program-id BvVePGKKwuGb6QVJHG6LvCrULB7QBgjocqnYxYHUkNEd create-token --enable-freeze --default-account-state frozen
Creating token 8Sqz2zV8TFTnkLtnCdqRkjJsre3GKRwHcZd3juE5jJHf under program BvVePGKKwuGb6QVJHG6LvCrULB7QBgjocqnYxYHUkNEd
...
SPL Token Account
  ...
  Program: BvVePGKKwuGb6QVJHG6LvCrULB7QBgjocqnYxYHUkNEd
  Balance: 0
  Decimals: 9
...
```console
$ spl-token --program-id BvVePGKKwuGb6QVJHG6LvCrULB7QBgjocqnYxYHUkNEd create-token
Creating token CZxztd7SEZWxg6B9PH5xa7QwKpMCpWBJiTLftw1o3qyV under program BvVePGKKwuGb6QVJHG6LvCrULB7QBgjocqnYxYHUkNEd
...
```console
$ spl-token --program-id BvVePGKKwuGb6QVJHG6LvCrULB7QBgjocqnYxYHUkNEd create-token --enable-non-transferable
Creating token 7De7wwkvNLPXpShbPDeRCLukb3CRzCNcC3iUuHtD6k4f under program BvVePGKKwuGb6QVJHG6LvCrULB7QBgjocqnYxYHUkNEd
...
```console
$ spl-token --program-id BvVePGKKwuGb6QVJHG6LvCrULB7QBgjocqnYxYHUkNEd create-token
Creating token EbPBt3XkCb9trcV4c8fidhrvoeURbDbW87Acustzyi8N under program BvVePGKKwuGb6QVJHG6LvCrULB7QBgjocqnYxYHUkNEd
...
```console
$ spl-token --program-id BvVePGKKwuGb6QVJHG6LvCrULB7QBgjocqnYxYHUkNEd create-token --interest-rate 10
Creating token 7N4HggYEJAtCLJdnHGCtFqfxcB5rhQCsQTze3ftYstVj under program BvVePGKKwuGb6QVJHG6LvCrULB7QBgjocqnYxYHUkNEd
