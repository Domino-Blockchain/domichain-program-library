use {
    crate::{
        ...
        domichain_zk_token_sdk::zk_token_elgamal::pod::TransferAmountCiphertext,
        state::{Account, Mint},
    },
    domichain_program::{
...
fn process_transfer(
    ...
    if mint.get_extension::<TransferFeeConfig>().is_err() {
        ...
        if !confidential_transfer_mint
            ...
            .equals(&proof_context.transfer_pubkeys.auditor_pubkey)
        {
            return Err(TokenError::ConfidentialTransferElGamalPubkeyMismatch.into());
        }
        ...
        process_source_for_transfer(
            ...
            authority_info,
            account_info_iter.as_slice(),
            &proof_context.transfer_pubkeys.source_pubkey,
        ...
        process_destination_for_transfer(
            ...
            mint_info,
            &proof_context.transfer_pubkeys.destination_pubkey,
        ...
        if !confidential_transfer_mint
            .auditor_elgamal_pubkey
            .equals(&proof_context.transfer_with_fee_pubkeys.auditor_pubkey)
        {
            return Err(TokenError::ConfidentialTransferElGamalPubkeyMismatch.into());
        }
        ...
        process_source_for_transfer(
            ...
            authority_info,
            account_info_iter.as_slice(),
            &proof_context.transfer_with_fee_pubkeys.source_pubkey,
            &source_transfer_amount_lo,
            &source_transfer_amount_hi,
            &proof_context.new_source_ciphertext,
            new_source_decryptable_available_balance,
        ...
        process_destination_for_transfer(
            destination_token_account_info,
            mint_info,
            &proof_context.transfer_with_fee_pubkeys.destination_pubkey,
