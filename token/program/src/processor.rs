...
impl Processor {
    ...
    fn _process_initialize_account(
        ...
        // msg!("Instruction: InitializeAccount {}", line!());
        let account_info_iter = &mut accounts.iter();
        // msg!("Instruction: InitializeAccount {}", line!());
        ...
        // msg!("Instruction: InitializeAccount {}", line!());
        let a = Box::new(mint_info.key.clone());
        let b = Box::new(crate::native_mint::id());
        // msg!("Instruction: InitializeAccount {}", line!());
        let is_native_mint = a.to_bytes() == b.to_bytes();
        // let is_native_mint = Self::cmp_pubkeys(a.as_ref(), b.as_ref());
        // msg!("Instruction: InitializeAccount {}", line!());
        if !is_native_mint {
    ...
    pub fn cmp_pubkeys(a: &Pubkey, b: &Pubkey) -> bool {
        Self::cmp_pubkeys_slow(a, b)
        // sol_memcmp(a.as_ref(), b.as_ref(), PUBKEY_BYTES) == 0
    }

    /// Checks two pubkeys for equality in a computationally cheap way using
    /// `sol_memcmp`
    pub fn cmp_pubkeys_slow(a: &Pubkey, b: &Pubkey) -> bool {
        a == b
    }
